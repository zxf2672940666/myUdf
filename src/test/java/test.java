...
public class test extends UDF {
    public static String regReplace(String url){
        URL url1 = null;
        try {
            url1 = new URL(url);
    ...
    public static Text evaluate(Text url, Text name) {
        ...
        String pagename="";
        if (urlParse(u, "host", "app.mafengwo.cn") || Pattern.matches("app.mafengwo.cn",u)) {
            //1.host="app.mafengwo.cn"
            if (urlParse(u, "path", "/user/comment_list")) { pagename = "用户点评列表";}
            else if (name1 != "" ) { pagename = name1;}
            else {pagename = null;}
        }
        else if (urlParse(u, "host", "payitf.mafengwo.cn" )) {
            //2.host="payitf.mafengwo.cn"
            if (urlParse(u, "path", "cloudauth/material")) { pagename = "pay_four_points_check";}
            else if (urlParse(u, "path", "esign/person/auth")) { pagename = "pay_face_check";}
            else if (urlParse(u, "path", "order/pay_v2/jumppay")) { pagename = "pay_jump_to_third";}
            else if (urlParse(u, "path", "/pay_v2/gopay")) { pagename = "pay_jump_to_paycenter";}
            else if (urlParse(u, "path", "/return/")) { pagename = "pay_back_to_order";} //是用户主动返回 一般没支付成功
            else if (urlParse(u, "path", "/pay_v2/guide")) { pagename = "pay_sucess";} //guide 收银台 付完款自动回调，也有情况是 没支付成功 ，刷新收银台
            else if (urlParse(u, "path", "/pay_v2/history")) { pagename = "pay_back_to_order";} //没支付成功，从收银台返回业务下单页（或者自定义）
            else if (urlParse(u, "path", "/order/pay_v2/404")) { pagename = "pay_fail_404";}
            else {pagename = null;}
        }
        else if (urlParse(u, "host", "passport.mafengwo.cn")) {
            //3.host="passport.mafengwo.cn"
            if (urlParse(u, "path", "forget")) { pagename = "account_forget";}
            else if (urlParse(u, "query", "", "return_url")) { pagename = "account_login";}
            else if (urlParse(u, "path", "passport.mafengwo.cn/$")) { pagename = "account_login";}
            else if (urlParse(u, "path", "reset")) { pagename = "account_reset";}
            else if (urlParse(u, "path", "setting/wallet/")) { pagename = "account_wallet";}
            else if (urlParse(u, "path", "/wechat/auth/")) { pagename = "account_wechat_auth";}
            else if (urlParse(u, "path", "/qq/auth/")) { pagename = "account_qq_auth";}
            else if (urlParse(u, "path", "/qq")) { pagename = "account_qq_auth";}
            else if (urlParse(u, "path", "/wechat")) { pagename = "account_wechat_auth";}
            else if (urlParse(u, "path", "/setting/security/")) { pagename = "account_security";}
            else if (urlParse(u, "path", "/")) { pagename = "account_login";}
            else {pagename = null;}
        }
        else if (urlParse(u, "host", "w.mafengwo.cn")){
            //4.host="w.mafengwo.cn"
            if (urlParse(u, "path", "calendar2019")) { pagename = "马蜂窝台历";} //https://w.mafengwo.cn/calendar2019/preheat
            else if (urlParse(u, "path", "2018-gq-light/")) { pagename = "点亮全球";}
            else if (urlParse(u, "path", "/activity_light_global/")) { pagename = "点亮全球";}
            else if (urlParse(u, "path", "/activity_footballbaby_home/")) { pagename = "世界杯足球宝贝";}
            else if (urlParse(u, "path", "/sales_promotion/")) { pagename = "电商促销活动";} //https://w.mafengwo.cn/sales_promotion/recruit/index
            else if (urlParse(u, "path", "/activity_fancy_note/")) { pagename = "游记活动";}
            else if (urlParse(u, "path", "/mfw_activity_new/")) { pagename = "社区活动";}
            else if (urlParse(u, "path", "aps/book/")) { pagename = "品牌活动";} //https://w.mafengwo.cn/aps/book/unknowtravel/v2/index.html
            else if (urlParse(u, "path", "activity_honeycomb")) { pagename = "品牌活动";} //https://w.mafengwo.cn/activity_honeycomb/
            else if (urlParse(u, "path", "activity_group_intro")) { pagename = "未知饭局";} //https://w.mafengwo.cn/activity_group_intro/479729
            else if (urlParse(u, "path", "/h5-best-answerer/")) { pagename = "问答活动";} //https://w.mafengwo.cn/h5-best-answerer/index.html#/
            else if (urlParse(u, "path", "/find_traveler/")) { pagename = "问答活动";} //答题大赛寻找旅行X星人    https://w.mafengwo.cn/find_traveler/index.html?id=10#/
            else if (urlParse(u, "path", "/activity_qList/")) { pagename = "问答活动";}
            else if (urlParse(u, "path", "/worldcup2018/")) { pagename = "世界杯活动";}
            else if (urlParse(u, "path", "/worldcup_task/")) { pagename = "世界杯活动任务";}
            else if (urlParse(u, "path", "/activity_qList/index")) { pagename = "问答精选讨论";}
            else if (urlParse(u, "path", "/daka/")) { pagename = "用户打卡页";}
            else if (urlParse(u, "path", "/gy-delicacy/")) { pagename = "目的地活动";}
            else if (urlParse(u, "path", "/activity_reserve_note/")) { pagename = "游记活动";} //https://w.mafengwo.cn/activity_reserve_note/index
            else if (urlParse(u, "path", "/activity_dt_destination/")) { pagename = "问答活动";} //https://w.mafengwo.cn/activity_dt_destination/index.html?id=48#/
            else if (Pattern.matches("/sales_fe/index.html#/wxapp/laxin/index",u)) { pagename = "app下载";} //https://w.mafengwo.cn/sales_fe/index.html#/wxapp/laxin/index
            else if (urlParse(u, "path", "/group_h5/article_detail/")) { pagename = "小组介绍页";} //小组介绍页   https://w.mafengwo.cn/group_h5/article_detail/******
            else if (urlParse(u, "path", "/group_h5/comment_list/")) { pagename = "小组评论列表页";} //小组评论列表页 https://w.mafengwo.cn/group_h5/comment_list/*******
            else if (urlParse(u, "path", "/group_h5/group_list/")) { pagename = "小组列表页";} //小组列表页   https://w.mafengwo.cn/group_h5/group_list/*******
            else if (urlParse(u, "path", "/group_h5/group_my/")) { pagename = "我的小组页";} //我的小组页   https://w.mafengwo.cn/group_h5/group_my/
            else if (Pattern.matches("group_h5/publish\\?id=",u)) { pagename = "发布活动页面";} //发布活动页面  https://w.mafengwo.cn/group_h5/publish?id=******
            else if (urlParse(u, "path", "/group_h5/publish")) { pagename = "小组活动发布页";} //小组活动发布页 https://w.mafengwo.cn/group_h5/publish
            else if (urlParse(u, "path", "/activity_city/home")) { pagename = "目的地同城活动主页面";} //目的地同城活动主页面    https://w.mafengwo.cn/activity_city/home?activity_id=****
            else if (urlParse(u, "path", "/activity_city/Home")) { pagename = "目的地同城活动主页面";}
            else if (urlParse(u, "path", "activity_city/launch")) { pagename = "同城活动发起页面";} //同城活动发起页面    https://w.mafengwo.cn/activity_city/launch?mdd_id=1&mddId=******
            else if (Pattern.matches("/activity_city/\\?mdd_id=",u)) { pagename = "目的地同城活动列表页";} //全部同城活动列表页   https://w.mafengwo.cn/activity_city/list
            else if (urlParse(u, "path", "/activity_city/list")) { pagename = "全部同城活动列表页";} //目的地同城活动列表页  https://w.mafengwo.cn/activity_city/list?mdd_id=*****
            else if (urlParse(u, "path", "/activity_city/manage")) { pagename = "同城活动管理页";} //https://w.mafengwo.cn/activity_city/manage?activity_id=60615&user_type=1
            else if (urlParse(u, "path", "/sales_exp_report/index\\.html")) { pagename = "旅行体验首页";} // https://w.mafengwo.cn/sales_exp_report/index.html?from=order_center
            else if (urlParse(u, "path", "sales_exp_report/detail\\.html")) { pagename = "旅行体验详情页";}
            else if (urlParse(u, "path", "sales_exp_report/comment")) { pagename = "旅行体验点评";} //https://w.mafengwo.cn/sales_exp_report/comment.html?report_id=90802
            else if (urlParse(u, "path", "trans_car_flight/index.html")) { pagename = "接送机首页";} //https://w.mafengwo.cn/trans_car_flight/index.html#/
            else if (urlParse(u, "path", "/trans_car_flight/orderWrite.html")) { pagename = "接送机提交订单";} //https://w.mafengwo.cn/trans_car_flight/orderWrite.html?carTypeCode=300005&carTypeName=%E8%B1%AA%E5%8D%8E5%E5%BA%A7&vendorCode=YITU8&merchantPriceMark=40e867db2f389e1f&price=653&activityPrice=0&bizType=1&airportCode=TPE&depAddress=%E6%A1%83%E5%9B%AD%E6%9C%BA%E5%9C%BA&depLon=121.233002&depLat=25.0777&arrAddress=269%E5%8F%B0%E6%B9%BE%E5%AE%9C%E8%98%AD%E7%B8%A3%E5%86%AC%E5%B1%B1%E9%84%89%E8%8C%84%E8%8B%B3%E8%B7%AF219%E8%99%9F&cityName=%E5%8F%B0%E5%8C%97&arrLon=121.8061505&arrLat=24.6562023&serviceTime=2018-11-02%2023%3A55%3A00&baggageCount=2&seatCount=4&insurancePrice=0&liftcardPrice=0&guidePrice=0&childrenPrice=0&flightNo=CI928&airlineCompany=%25E4%25B8%25AD%25E5%258D%258E%25E8%2588%25AA%25E7%25A9%25BA&tagInfo=%E4%B8%AD%E6%96%87%E5%8F%B8%E6%9C%BA&serviceTimeBj=2018-11-01%2021%3A55%3A00&imgUrl=https%3A%2F%2Fp4-q.mafengwo.net%2Fs11%2FM00%2F90%2FC6%2FwKgBEFtn7WuAD_1jAAAwSnetlKU456.png
            else if (Pattern.matches("sales_customize/scheme_info\\?demand_id",u)) { pagename = "电商定制方案详情";}
            else if (urlParse(u, "path", "/sales_customize/demand_submission")) { pagename = "电商定制需求提交";} //https://w.mafengwo.cn/sales_customize/demand_submission?line_mdd_id=14407&entry_type=&entry_id=&hash_key=
            else if (urlParse(u, "path", "/sales_customize/mdd_entrance")) { pagename = "电商目的地定制频道";} //https://w.mafengwo.cn/sales_customize/mdd_entrance?line_mdd_id=10065&track_id=1000
            else if (urlParse(u, "path", "/sales_customize/submit_success")) { pagename = "电商定制需求提交成功";} //https://w.mafengwo.cn/sales_customize/submit_success?demand_id=1615341583524497
            else if (urlParse(u, "path", "/sales_customize/contract")) { pagename = "电商定制查看合同";}
            else if (urlParse(u, "path", "/sales_customize/scheme")) { pagename = "电商定制方案详情";} // https://w.mafengwo.cn/sales_customize/scheme?id=1615301099196474
            else if (urlParse(u, "path", "/trans_flight_lpc/content.html")) { pagename = "大交通频道-特价机票首页";} ////- update by SynHao at 20180914 09:28
            else if (urlParse(u, "path", "/trans_flight_lpc/stroke.html")) { pagename = "大交通频道-特价机票行程页";}
            else if (urlParse(u, "path", "/trans_car_flight/selectCar.html")) { pagename = "接送机租车频道-接送机选车页";} //https://w.mafengwo.cn//trans_car_flight/selectCar.html
            else if (urlParse(u, "path", "/trans_car_flight/activity.html")) { pagename = "接送机租车频道-大促活动";} //https://w.mafengwo.cn//trans_car_flight/selectCar.html
            else if (urlParse(u, "path", "/sales/shop/page/impression")) { pagename = "电商店铺印象";}
            else if (urlParse(u, "path", "/sales/order/booking/supply")) { pagename = "交易频道-出行信息完善页";}
            else if (Pattern.matches("/sales_fe/index.html#/cityPlay/",u)) { pagename = "电商城市玩法";} //https://w.mafengwo.cn/sales_fe/index.html#/cityPlay/10183
            else if (Pattern.matches("/sales_fe/index.html#/soptTicket",u)) { pagename = "电商门票";} //https://w.mafengwo.cn/sales_fe/index.html#/soptTicket?poi_id=6102028&cdid=945&mi=12562%7C972
            else if (Pattern.matches("/sales_fe/index.html\\?\\d+#/soptTicket",u)) { pagename = "电商门票";} //https://w.mafengwo.cn/sales_fe/index.html#/soptTicket?poi_id=6102028&cdid=945&mi=12562%7C972
            else if (Pattern.matches("/sales_car/index.html#/car/",u)) { pagename = "大交通-接送机首页";} //https://w.mafengwo.cn/sales_car/index.html#/car/osd
            else if (Pattern.matches("/sales_fe/index.html#/temai",u)) { pagename = "电商特卖";} //https://w.mafengwo.cn/sales_fe/index.html#/temai
            else if (Pattern.matches("/sales_fe/index.html#/guideAlbum",u)) { pagename = "电商攻略";} //https://w.mafengwo.cn/sales_fe/index.html#/guideAlbum?id=466
            else if (Pattern.matches("/sales_fe/index.html#/newUserGift",u)) { pagename = "电商优惠券";}
            else if (Pattern.matches("/sales_fe/index.html#/popularList",u)) { pagename = "附近好店人气榜";}
            else if (Pattern.matches("/sales_fe/index.html#/vip/",u)) { pagename = "金卡会员";}
            else if (Pattern.matches("/sales_fe/index.html#/wanfa/detail",u)) { pagename = "电商玩法详情页";} //https://w.mafengwo.cn/sales_fe/index.html#/wanfa/detail/333
            else if (Pattern.matches("/sales_train/index.html#/train/detail/\\d+",u)) { pagename = "大交通火车票订单详情";} //https://w.mafengwo.cn/sales_train/index.html#/train/detail/1615185184145766
            else if (Pattern.matches("/sales_fe/index.html#/quickbook/",u)) { pagename = "电商必体验产品列表页";} //https://w.mafengwo.cn/sales_fe/index.html#/quickbook/10035/49646
            else if (Pattern.matches("/sales_train/index.html#/train/list",u)) { pagename = "大交通火车票列表页";} //https://w.mafengwo.cn/sales_train/index.html#/train/list?depart_code=beijing&depart_name=%E5%8C%97%E4%BA%AC&dest_code=shanghai&dest_name=%E4%B8%8A%E6%B5%B7&depart_date=2018-10-25&high_speed_rail=0
            else if (Pattern.matches("/sales_fe/index.html#/packageHub",u)) { pagename = "电商打包产品";} //https://w.mafengwo.cn/sales_fe/index.html#/packageHub?id=118
            else if (Pattern.matches("sales_fe/index.html#/ticketCommentDetail",u)) { pagename = "电商门票点评";} //  https://w.mafengwo.cn/sales_fe/index.html#/ticketCommentDetail?poi_id=5429475
            else if (Pattern.matches("/sales_fe/index.html\\?_time=\\d+#/shop/trends/",u)) { pagename = "电商店铺动态";} //70    https://w.mafengwo.cn/sales_fe/index.html?_time=1540224566#/shop/trends/51935
            else if (Pattern.matches("/sales_fe/index.html\\?_time=\\d+#/shop/video",u)) { pagename = "电商店铺视频";} //https://w.mafengwo.cn/sales_fe/index.html?_time=1540651516#/shop/video/22704
            else if (urlParse(u, "path", "/activity_city/myActivity")) { pagename = "我的活动";} //add 201901
            else if (urlParse(u, "path", "/group_h5/group_my")) { pagename = "我的小组";} //add 201901
            else if (urlParse(u, "path", "/hotel_open_platform/")) { pagename = "开放平台";} //add 201901
            else if (urlParse(u, "path", "/mshequ/medal/index")) { pagename = "我的旅行勋章";} //add 201901
            else if (urlParse(u, "path", "/mshequ/passport/bind_phone")) { pagename = "绑定手机号";} //add 201901
            else if (urlParse(u, "path", "/sales_customize/answer")) { pagename = "定制旅行频道-问答导流页";} //add 201901
            else if (urlParse(u, "path", "/sales_customize/jump_back")) { pagename = "定制旅行频道- 技术功能页（无业务信息）";} //add 201901
            else if (urlParse(u, "path", "/sales_exp_report/list.html")) { pagename = "商城旅行体验-频道首页";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/cmt_complete.html")) { pagename = "点评完成";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/cmt_edit.html")) { pagename = "写点评";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/qa_answer.html")) { pagename = "电商-提交问答页";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/qa_detail.html")) { pagename = "问答详情 ";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/qa_question.html")) { pagename = "电商-问答提问页";} //add 201901
            else if (urlParse(u, "path", "/sfe-app/quickbook.html")) { pagename = "极速预订频道-极速预订产品列表页";} //add 201901
            else if (urlParse(u, "path", "/trans_car_flight/game.html")) { pagename = "接送机租车频道-疯狂小汽车活动页";} //add 201901
            else if (urlParse(u, "path", "/trans_car_flight/orderDetail.html")) { pagename = "接送机租车频道-接送机订单详情页";} //add 201901
            else {pagename = null;} //end
        }
        else if (urlParse(u, "host", "imfw.cn")) { pagename = "short_url";}
        else if (urlParse(u, "host", "topic.mafengwo.cn")) { pagename = "topic_activity";}
        else if (urlParse(u, "host","www.mafengwo.cn") || urlParse(u, "host","m.mafengwo.cn")) {
                     if (urlParse(u, "path", "/hotel/|/hotelzd/|/youyu/|/hotel_zx/")) {
                     if (Pattern.matches("from=app_travelguide_ios", u)) {
                    pagename = "跳转中间页";
                } else if (Pattern.matches("from=app_travelguide_android", u)) {
                    pagename = "跳转中间页";
                } else if (Pattern.matches("from=app_ios", u)) {
                    pagename = "跳转中间页";
                } else if (Pattern.matches("from=app_android", u)) {
                    pagename = "跳转中间页";
                    ...
                    if (urlParse(u, "path", "refer_line/mdd_entrance.php") && !urlParse(u, "query", "", "track_id")) {
                        pagename = "电商目的地定制频道";
                    } else if (urlParse(u, "path", "refer_line/mdd_entrance.php") && urlParse(u, "query", "", "track_id")) {
                        pagename = "电商商城定制频道";
                    ...
                    else if (urlParse(u, "path", "customize/v2$") && !urlParse(u, "query", "", "demand_id")) {
                        pagename = "电商定制方案详情";
        ...
        else if (urlParse(u, "host", "mafengwo")) { pagename = "马蜂窝新域名页面";}
        else if (Pattern.matches("/hotel/order_detail/index",u)) { pagename = "酒店订单详情";}
        else if (Pattern.matches("/hotel/activity",u)) { pagename = "酒店大促活动";}
        else {pagename="非马蜂窝页面";}
        if(pagename==null){
            return null;
        }
    ...
    public  static Boolean urlParse(String url, String type, String reg) {
        return urlParse(url, type, reg,null);
    }
    private static Boolean urlParse(String url, String type, String reg, String quekey) {
        URL url1 = null;
        try {
            url1 = new URL(url);
        } catch (MalformedURLException e) {
...
//        System.out.println(ref);
    ...
    public  boolean regpa(String u,String reg){
        Pattern pattern = Pattern.compile(reg);
    ...
    public static void main(String[] args) {
        String myurl="https://w.mafengwo.cn/sales_fe/index.html?26266280#/soptTicket?poi_id=26266280";
        Text text=new Text(myurl);
        Text text1=new Text("酒店下单流程-预订结果页");
        System.out.println(evaluate(text,text1)+"====");
        Pattern pattern = Pattern.compile("/sales_fe/index.html\\?\\d+#/soptTicket");
        Matcher matcher = pattern.matcher(myurl);
        System.out.println(matcher.find());
        System.out.println(urlParse(myurl, "path", "//sales_fe/index.html\\\\?\\\\d+#/soptTicket/"));
