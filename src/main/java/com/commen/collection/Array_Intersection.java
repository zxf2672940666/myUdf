...
/**
 * @program: myUdf
 * @description: 用于返回几个数组的交集
 * @author: LiuSenGen
 * @create: 2019-01-24 17:36
 **/
public class Array_Intersection extends GenericUDF {
    private static final Logger LOG = Logger.getLogger(Array_Intersection.class);
